...
// ==============================================================
#ifndef __calcola_sdiv_32s_bkb__HH__
#define __calcola_sdiv_32s_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(calcola_sdiv_32s_bkb) {
    ...
    SC_CTOR(calcola_sdiv_32s_bkb):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
