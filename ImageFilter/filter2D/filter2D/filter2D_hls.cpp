...
//creazione dei cavi fisici con annessa la loro allocazione in memoria
...
//due immagini la prima è quella da manipolare data in input,la seconda è quella che verrà
//sovrascritta con il risultato de la manipolazione della prima
...
//(fase read) partizionamento in 4 buffer dello stream fornito
//in input (pipelining) ognuno dei quali parte ogni 4 cicli di clock lettura( II=4)
...
//(kernel) assegnazione dei valori alla maschera tramite jupyter notebook
...
//(fase compute) viene richiamata la funzione cvfilter2d
...
//(fase write)si ricompongono i buffer e viene assegnato all'out_buffer
