...
// ==============================================================
#ifndef __filter2D_hls_mac_fYi__HH__
#define __filter2D_hls_mac_fYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter2D_hls_mac_fYi) {
    ...
    SC_CTOR(filter2D_hls_mac_fYi):  simcore_mac_0_U ("simcore_mac_0_U") {
