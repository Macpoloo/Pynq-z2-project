...
// ==============================================================
#ifndef __filter2D_hls_mac_g8j__HH__
#define __filter2D_hls_mac_g8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter2D_hls_mac_g8j) {
    ...
    SC_CTOR(filter2D_hls_mac_g8j):  simcore_mac_1_U ("simcore_mac_1_U") {
