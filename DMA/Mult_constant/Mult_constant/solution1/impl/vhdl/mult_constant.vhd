...
architecture behav of mult_constant is 
    ...
    "mult_constant,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.510000,HLS_SYN_LAT=3,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=3,HLS_SYN_FF=412,HLS_SYN_LUT=675,HLS_VERSION=2018_3}";
    ...
    signal in_data_data_V_tmp_reg_140 : STD_LOGIC_VECTOR (31 downto 0);
    signal in_data_keep_V_tmp_reg_145 : STD_LOGIC_VECTOR (3 downto 0);
    signal in_data_strb_V_tmp_reg_150 : STD_LOGIC_VECTOR (3 downto 0);
    signal in_data_user_V_tmp_reg_155 : STD_LOGIC_VECTOR (0 downto 0);
    signal in_data_last_V_tmp_reg_160 : STD_LOGIC_VECTOR (0 downto 0);
    signal in_data_id_V_tmp_reg_165 : STD_LOGIC_VECTOR (0 downto 0);
    signal in_data_dest_V_tmp_reg_170 : STD_LOGIC_VECTOR (0 downto 0);
    signal constant_V_read_reg_175 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                constant_V_read_reg_175 <= constant_V_0_data_reg;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (in_data_data_V_0_vld_out = ap_const_logic_1))) then
                in_data_data_V_tmp_reg_140 <= in_data_data_V_0_data_out;
                in_data_dest_V_tmp_reg_170 <= in_data_dest_V_0_data_out;
                in_data_id_V_tmp_reg_165 <= in_data_id_V_0_data_out;
                in_data_keep_V_tmp_reg_145 <= in_data_keep_V_0_data_out;
                in_data_last_V_tmp_reg_160 <= in_data_last_V_0_data_out;
                in_data_strb_V_tmp_reg_150 <= in_data_strb_V_0_data_out;
                in_data_user_V_tmp_reg_155 <= in_data_user_V_0_data_out;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_data_dest_V_1_load_A = ap_const_logic_1)) then
                out_data_dest_V_1_payload_A <= in_data_dest_V_tmp_reg_170;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_data_dest_V_1_load_B = ap_const_logic_1)) then
                out_data_dest_V_1_payload_B <= in_data_dest_V_tmp_reg_170;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_data_id_V_1_load_A = ap_const_logic_1)) then
                out_data_id_V_1_payload_A <= in_data_id_V_tmp_reg_165;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_data_id_V_1_load_B = ap_const_logic_1)) then
                out_data_id_V_1_payload_B <= in_data_id_V_tmp_reg_165;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_data_keep_V_1_load_A = ap_const_logic_1)) then
                out_data_keep_V_1_payload_A <= in_data_keep_V_tmp_reg_145;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_data_keep_V_1_load_B = ap_const_logic_1)) then
                out_data_keep_V_1_payload_B <= in_data_keep_V_tmp_reg_145;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_data_last_V_1_load_A = ap_const_logic_1)) then
                out_data_last_V_1_payload_A <= in_data_last_V_tmp_reg_160;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_data_last_V_1_load_B = ap_const_logic_1)) then
                out_data_last_V_1_payload_B <= in_data_last_V_tmp_reg_160;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_data_strb_V_1_load_A = ap_const_logic_1)) then
                out_data_strb_V_1_payload_A <= in_data_strb_V_tmp_reg_150;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_data_strb_V_1_load_B = ap_const_logic_1)) then
                out_data_strb_V_1_payload_B <= in_data_strb_V_tmp_reg_150;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_data_user_V_1_load_A = ap_const_logic_1)) then
                out_data_user_V_1_payload_A <= in_data_user_V_tmp_reg_155;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    in_data_TDATA_blk_n_assign_proc : process(in_data_data_V_0_state, ap_CS_fsm_state1)
    begin
    ...
    in_data_data_V_0_ack_out_assign_proc : process(in_data_data_V_0_vld_out, ap_CS_fsm_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (in_data_data_V_0_vld_out = ap_const_logic_1))) then 
    ...
    in_data_dest_V_0_ack_out_assign_proc : process(in_data_data_V_0_vld_out, ap_CS_fsm_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (in_data_data_V_0_vld_out = ap_const_logic_1))) then 
    ...
    in_data_id_V_0_ack_out_assign_proc : process(in_data_data_V_0_vld_out, ap_CS_fsm_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (in_data_data_V_0_vld_out = ap_const_logic_1))) then 
    ...
    in_data_keep_V_0_ack_out_assign_proc : process(in_data_data_V_0_vld_out, ap_CS_fsm_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (in_data_data_V_0_vld_out = ap_const_logic_1))) then 
    ...
    in_data_last_V_0_ack_out_assign_proc : process(in_data_data_V_0_vld_out, ap_CS_fsm_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (in_data_data_V_0_vld_out = ap_const_logic_1))) then 
    ...
    in_data_strb_V_0_ack_out_assign_proc : process(in_data_data_V_0_vld_out, ap_CS_fsm_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (in_data_data_V_0_vld_out = ap_const_logic_1))) then 
    ...
    in_data_user_V_0_ack_out_assign_proc : process(in_data_data_V_0_vld_out, ap_CS_fsm_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (in_data_data_V_0_vld_out = ap_const_logic_1))) then 
    ...
    out_data_data_V_tmp_fu_135_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed(in_data_data_V_tmp_reg_140) * signed(constant_V_read_reg_175))), 32));
