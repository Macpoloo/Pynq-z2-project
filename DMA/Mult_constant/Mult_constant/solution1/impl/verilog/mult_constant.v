...
(* CORE_GENERATION_INFO="mult_constant,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.510000,HLS_SYN_LAT=3,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=3,HLS_SYN_FF=412,HLS_SYN_LUT=675,HLS_VERSION=2018_3}" *)
...
reg  signed [31:0] in_data_data_V_tmp_reg_140;
reg   [3:0] in_data_keep_V_tmp_reg_145;
reg   [3:0] in_data_strb_V_tmp_reg_150;
reg   [0:0] in_data_user_V_tmp_reg_155;
reg   [0:0] in_data_last_V_tmp_reg_160;
reg   [0:0] in_data_id_V_tmp_reg_165;
reg   [0:0] in_data_dest_V_tmp_reg_170;
reg  signed [31:0] constant_V_read_reg_175;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (in_data_data_V_0_vld_out == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if ((~((out_data_dest_V_1_ack_in == 1'b0) | (out_data_id_V_1_ack_in == 1'b0) | (out_data_last_V_1_ack_in == 1'b0) | (out_data_user_V_1_ack_in == 1'b0) | (out_data_strb_V_1_ack_in == 1'b0) | (out_data_keep_V_1_ack_in == 1'b0) | (out_data_data_V_1_ack_in == 1'b0)) & (out_data_dest_V_1_state[1'd0] == 1'b0) & (out_data_id_V_1_state[1'd0] == 1'b0) & (out_data_last_V_1_state[1'd0] == 1'b0) & (out_data_user_V_1_state[1'd0] == 1'b0) & (out_data_strb_V_1_state[1'd0] == 1'b0) & (out_data_keep_V_1_state[1'd0] == 1'b0) & (out_data_data_V_1_state[1'd0] == 1'b0) & (1'b1 == ap_CS_fsm_state4))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end
...
assign out_data_data_V_tmp_fu_135_p2 = ($signed(in_data_data_V_tmp_reg_140) * $signed(constant_V_read_reg_175));
