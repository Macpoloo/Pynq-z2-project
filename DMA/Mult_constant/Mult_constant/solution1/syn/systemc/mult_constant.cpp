...
mult_constant::mult_constant(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( in_data_data_V_tmp_reg_140 );
    sensitive << ( constant_V_read_reg_175 );
    ...
    sc_trace(mVcdFile, in_data_data_V_tmp_reg_140, "in_data_data_V_tmp_reg_140");
    sc_trace(mVcdFile, in_data_keep_V_tmp_reg_145, "in_data_keep_V_tmp_reg_145");
    sc_trace(mVcdFile, in_data_strb_V_tmp_reg_150, "in_data_strb_V_tmp_reg_150");
    sc_trace(mVcdFile, in_data_user_V_tmp_reg_155, "in_data_user_V_tmp_reg_155");
    sc_trace(mVcdFile, in_data_last_V_tmp_reg_160, "in_data_last_V_tmp_reg_160");
    sc_trace(mVcdFile, in_data_id_V_tmp_reg_165, "in_data_id_V_tmp_reg_165");
    sc_trace(mVcdFile, in_data_dest_V_tmp_reg_170, "in_data_dest_V_tmp_reg_170");
    sc_trace(mVcdFile, constant_V_read_reg_175, "constant_V_read_reg_175");
...
void mult_constant::thread_ap_clk_no_reset_() {
  ...
  esl_seteq<1,1,1>(ap_const_logic_1, constant_V_0_ack_out.read())))) {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        constant_V_read_reg_175 = constant_V_0_data_reg.read();
    }
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(in_data_data_V_0_vld_out.read(), ap_const_logic_1))) {
        in_data_data_V_tmp_reg_140 = in_data_data_V_0_data_out.read();
        in_data_dest_V_tmp_reg_170 = in_data_dest_V_0_data_out.read();
        in_data_id_V_tmp_reg_165 = in_data_id_V_0_data_out.read();
        in_data_keep_V_tmp_reg_145 = in_data_keep_V_0_data_out.read();
        in_data_last_V_tmp_reg_160 = in_data_last_V_0_data_out.read();
        in_data_strb_V_tmp_reg_150 = in_data_strb_V_0_data_out.read();
        in_data_user_V_tmp_reg_155 = in_data_user_V_0_data_out.read();
    }
...
void mult_constant::thread_out_data_data_V_tmp_fu_135_p2() {
    out_data_data_V_tmp_fu_135_p2 = (!in_data_data_V_tmp_reg_140.read().is_01() || !constant_V_read_reg_175.read().is_01())? sc_lv<32>(): sc_bigint<32>(in_data_data_V_tmp_reg_140.read()) * sc_bigint<32>(constant_V_read_reg_175.read());
}
...
void mult_constant::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 4 : 
            ...
            break;
        case 8 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, out_data_data_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, out_data_keep_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, out_data_strb_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, out_data_user_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, out_data_last_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, out_data_id_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, out_data_dest_V_1_ack_in.read())) && esl_seteq<1,1,1>(ap_const_logic_0, out_data_data_V_1_state.read()[0]) && esl_seteq<1,1,1>(ap_const_logic_0, out_data_keep_V_1_state.read()[0]) && esl_seteq<1,1,1>(ap_const_logic_0, out_data_strb_V_1_state.read()[0]) && esl_seteq<1,1,1>(ap_const_logic_0, out_data_user_V_1_state.read()[0]) && esl_seteq<1,1,1>(ap_const_logic_0, out_data_last_V_1_state.read()[0]) && esl_seteq<1,1,1>(ap_const_logic_0, out_data_id_V_1_state.read()[0]) && esl_seteq<1,1,1>(ap_const_logic_0, out_data_dest_V_1_state.read()[0]))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
                ap_NS_fsm = ap_ST_fsm_state4;
            }
