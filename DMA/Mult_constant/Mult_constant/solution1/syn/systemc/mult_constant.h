...
struct mult_constant : public sc_module {
    ...
    sc_signal< sc_lv<32> > in_data_data_V_tmp_reg_140;
    sc_signal< sc_lv<4> > in_data_keep_V_tmp_reg_145;
    sc_signal< sc_lv<4> > in_data_strb_V_tmp_reg_150;
    sc_signal< sc_lv<1> > in_data_user_V_tmp_reg_155;
    sc_signal< sc_lv<1> > in_data_last_V_tmp_reg_160;
    sc_signal< sc_lv<1> > in_data_id_V_tmp_reg_165;
    sc_signal< sc_lv<1> > in_data_dest_V_tmp_reg_170;
    sc_signal< sc_lv<32> > constant_V_read_reg_175;
