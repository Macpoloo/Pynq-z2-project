...
architecture behav of trace_cntrl_64 is 
    ...
    "trace_cntrl_64,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.873000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=785,HLS_SYN_LUT=1074,HLS_VERSION=2018_3}";
    ...
    signal tmp_7_reg_320 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_enable_reg_pp0_iter2 : STD_LOGIC := '0';
    signal tmp_1_reg_286_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_7_reg_320_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal match_reg_135 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_reg_146 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_2_fu_173_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_7_fu_225_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_2_fu_231_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal samples_fu_76 : STD_LOGIC_VECTOR (31 downto 0);
    signal samples_1_fu_246_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal tmp_3_fu_211_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_5_fu_215_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_6_fu_220_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_1_fu_182_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_1_reg_286 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_7_fu_225_p2 = ap_const_lv1_1) and (tmp_1_fu_182_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_1_fu_182_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_7_fu_225_p2 = ap_const_lv1_1) and (tmp_1_fu_182_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                trace_temp_last_V_reg_325 <= trace_temp_last_V_fu_241_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, capture_64_data_V_1_ack_in, capture_64_data_V_1_state, capture_64_keep_V_1_ack_in, capture_64_keep_V_1_state, capture_64_strb_V_1_ack_in, capture_64_strb_V_1_state, capture_64_user_V_1_ack_in, capture_64_user_V_1_state, capture_64_last_V_1_ack_in, capture_64_last_V_1_state, capture_64_id_V_1_ack_in, capture_64_id_V_1_state, capture_64_dest_V_1_ack_in, capture_64_dest_V_1_state, ap_enable_reg_pp0_iter0, tmp_1_fu_182_p2, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_subdone, ap_CS_fsm_state5)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if ((not(((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (tmp_1_fu_182_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) and not(((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
            ...
            when ap_ST_fsm_state5 => 
                if ((not(((capture_64_dest_V_1_ack_in = ap_const_logic_0) or (capture_64_id_V_1_ack_in = ap_const_logic_0) or (capture_64_last_V_1_ack_in = ap_const_logic_0) or (capture_64_user_V_1_ack_in = ap_const_logic_0) or (capture_64_strb_V_1_ack_in = ap_const_logic_0) or (capture_64_keep_V_1_ack_in = ap_const_logic_0) or (capture_64_data_V_1_ack_in = ap_const_logic_0))) and (capture_64_dest_V_1_state(0) = ap_const_logic_0) and (capture_64_id_V_1_state(0) = ap_const_logic_0) and (capture_64_last_V_1_state(0) = ap_const_logic_0) and (capture_64_user_V_1_state(0) = ap_const_logic_0) and (capture_64_strb_V_1_state(0) = ap_const_logic_0) and (capture_64_keep_V_1_state(0) = ap_const_logic_0) and (capture_64_data_V_1_state(0) = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state5;
                end if;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(trace_64_data_V_0_vld_out, ap_enable_reg_pp0_iter0, tmp_1_fu_182_p2)
    begin
                ap_block_pp0_stage0_01001 <= ((tmp_1_fu_182_p2 = ap_const_lv1_1) and (trace_64_data_V_0_vld_out = ap_const_logic_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(trace_64_data_V_0_vld_out, ap_enable_reg_pp0_iter0, tmp_1_fu_182_p2, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_block_state3_io, ap_block_state4_io)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_const_boolean_1 = ap_block_state4_io) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_const_boolean_1 = ap_block_state3_io) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((tmp_1_fu_182_p2 = ap_const_lv1_1) and (trace_64_data_V_0_vld_out = ap_const_logic_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(trace_64_data_V_0_vld_out, ap_enable_reg_pp0_iter0, tmp_1_fu_182_p2, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_block_state3_io, ap_block_state4_io)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_const_boolean_1 = ap_block_state4_io) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_const_boolean_1 = ap_block_state3_io) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((tmp_1_fu_182_p2 = ap_const_lv1_1) and (trace_64_data_V_0_vld_out = ap_const_logic_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1)));
    end process;


    ap_block_state2_pp0_stage0_iter0_assign_proc : process(trace_64_data_V_0_vld_out, tmp_1_fu_182_p2)
    begin
                ap_block_state2_pp0_stage0_iter0 <= ((tmp_1_fu_182_p2 = ap_const_lv1_1) and (trace_64_data_V_0_vld_out = ap_const_logic_0));
    end process;


    ap_block_state3_io_assign_proc : process(capture_64_data_V_1_ack_in, ap_predicate_op60_write_state3)
    begin
                ap_block_state3_io <= ((capture_64_data_V_1_ack_in = ap_const_logic_0) and (ap_predicate_op60_write_state3 = ap_const_boolean_1));
    end process;

        ap_block_state3_pp0_stage0_iter1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state4_io_assign_proc : process(capture_64_data_V_1_ack_in, ap_predicate_op63_write_state4)
    begin
                ap_block_state4_io <= ((capture_64_data_V_1_ack_in = ap_const_logic_0) and (ap_predicate_op63_write_state4 = ap_const_boolean_1));
    end process;

        ap_block_state4_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state5_assign_proc : process(capture_64_data_V_1_ack_in, capture_64_keep_V_1_ack_in, capture_64_strb_V_1_ack_in, capture_64_user_V_1_ack_in, capture_64_last_V_1_ack_in, capture_64_id_V_1_ack_in, capture_64_dest_V_1_ack_in)
    begin
                ap_block_state5 <= ((capture_64_dest_V_1_ack_in = ap_const_logic_0) or (capture_64_id_V_1_ack_in = ap_const_logic_0) or (capture_64_last_V_1_ack_in = ap_const_logic_0) or (capture_64_user_V_1_ack_in = ap_const_logic_0) or (capture_64_strb_V_1_ack_in = ap_const_logic_0) or (capture_64_keep_V_1_ack_in = ap_const_logic_0) or (capture_64_data_V_1_ack_in = ap_const_logic_0));
    end process;


    ap_condition_852_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0, tmp_1_fu_182_p2)
    begin
                ap_condition_852 <= ((ap_const_boolean_0 = ap_block_pp0_stage0) and (tmp_1_fu_182_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0));
    end process;


    ap_condition_pp0_exit_iter0_state2_assign_proc : process(tmp_1_fu_182_p2)
    begin
        if ((tmp_1_fu_182_p2 = ap_const_lv1_0)) then 
    ...
    ap_done_assign_proc : process(capture_64_data_V_1_ack_in, capture_64_data_V_1_state, capture_64_keep_V_1_ack_in, capture_64_keep_V_1_state, capture_64_strb_V_1_ack_in, capture_64_strb_V_1_state, capture_64_user_V_1_ack_in, capture_64_user_V_1_state, capture_64_last_V_1_ack_in, capture_64_last_V_1_state, capture_64_id_V_1_ack_in, capture_64_id_V_1_state, capture_64_dest_V_1_ack_in, capture_64_dest_V_1_state, ap_CS_fsm_state5)
    begin
        if ((not(((capture_64_dest_V_1_ack_in = ap_const_logic_0) or (capture_64_id_V_1_ack_in = ap_const_logic_0) or (capture_64_last_V_1_ack_in = ap_const_logic_0) or (capture_64_user_V_1_ack_in = ap_const_logic_0) or (capture_64_strb_V_1_ack_in = ap_const_logic_0) or (capture_64_keep_V_1_ack_in = ap_const_logic_0) or (capture_64_data_V_1_ack_in = ap_const_logic_0))) and (capture_64_dest_V_1_state(0) = ap_const_logic_0) and (capture_64_id_V_1_state(0) = ap_const_logic_0) and (capture_64_last_V_1_state(0) = ap_const_logic_0) and (capture_64_user_V_1_state(0) = ap_const_logic_0) and (capture_64_strb_V_1_state(0) = ap_const_logic_0) and (capture_64_keep_V_1_state(0) = ap_const_logic_0) and (capture_64_data_V_1_state(0) = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    ap_phi_mux_i_1_phi_fu_160_p4_assign_proc : process(i_reg_146, tmp_7_fu_225_p2, ap_phi_reg_pp0_iter0_i_1_reg_157, i_2_fu_231_p2, ap_condition_852)
    begin
        if ((ap_const_boolean_1 = ap_condition_852)) then
            if ((tmp_7_fu_225_p2 = ap_const_lv1_0)) then 
                ap_phi_mux_i_1_phi_fu_160_p4 <= i_2_fu_231_p2;
            elsif ((tmp_7_fu_225_p2 = ap_const_lv1_1)) then 
    ...
    ap_phi_mux_match_phi_fu_139_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_1_reg_286, tmp_7_reg_320, match_reg_135)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (tmp_1_reg_286 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_predicate_op60_write_state3_assign_proc : process(tmp_1_reg_286, tmp_7_reg_320)
    begin
                ap_predicate_op60_write_state3 <= ((tmp_7_reg_320 = ap_const_lv1_1) and (tmp_1_reg_286 = ap_const_lv1_1));
    end process;


    ap_predicate_op63_write_state4_assign_proc : process(tmp_1_reg_286_pp0_iter1_reg, tmp_7_reg_320_pp0_iter1_reg)
    begin
                ap_predicate_op63_write_state4 <= ((tmp_7_reg_320_pp0_iter1_reg = ap_const_lv1_1) and (tmp_1_reg_286_pp0_iter1_reg = ap_const_lv1_1));
    end process;


    ap_ready_assign_proc : process(capture_64_data_V_1_ack_in, capture_64_data_V_1_state, capture_64_keep_V_1_ack_in, capture_64_keep_V_1_state, capture_64_strb_V_1_ack_in, capture_64_strb_V_1_state, capture_64_user_V_1_ack_in, capture_64_user_V_1_state, capture_64_last_V_1_ack_in, capture_64_last_V_1_state, capture_64_id_V_1_ack_in, capture_64_id_V_1_state, capture_64_dest_V_1_ack_in, capture_64_dest_V_1_state, ap_CS_fsm_state5)
    begin
        if ((not(((capture_64_dest_V_1_ack_in = ap_const_logic_0) or (capture_64_id_V_1_ack_in = ap_const_logic_0) or (capture_64_last_V_1_ack_in = ap_const_logic_0) or (capture_64_user_V_1_ack_in = ap_const_logic_0) or (capture_64_strb_V_1_ack_in = ap_const_logic_0) or (capture_64_keep_V_1_ack_in = ap_const_logic_0) or (capture_64_data_V_1_ack_in = ap_const_logic_0))) and (capture_64_dest_V_1_state(0) = ap_const_logic_0) and (capture_64_id_V_1_state(0) = ap_const_logic_0) and (capture_64_last_V_1_state(0) = ap_const_logic_0) and (capture_64_user_V_1_state(0) = ap_const_logic_0) and (capture_64_strb_V_1_state(0) = ap_const_logic_0) and (capture_64_keep_V_1_state(0) = ap_const_logic_0) and (capture_64_data_V_1_state(0) = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    capture_64_TDATA_blk_n_assign_proc : process(capture_64_data_V_1_state, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_1_reg_286, tmp_7_reg_320, ap_enable_reg_pp0_iter2, tmp_1_reg_286_pp0_iter1_reg, tmp_7_reg_320_pp0_iter1_reg)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage0) and (tmp_7_reg_320_pp0_iter1_reg = ap_const_lv1_1) and (tmp_1_reg_286_pp0_iter1_reg = ap_const_lv1_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_const_boolean_0 = ap_block_pp0_stage0) and (tmp_7_reg_320 = ap_const_lv1_1) and (tmp_1_reg_286 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    capture_64_data_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_predicate_op60_write_state3, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op60_write_state3 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    capture_64_dest_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_predicate_op60_write_state3, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op60_write_state3 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    capture_64_id_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_predicate_op60_write_state3, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op60_write_state3 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    capture_64_keep_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_predicate_op60_write_state3, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op60_write_state3 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    capture_64_last_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_predicate_op60_write_state3, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op60_write_state3 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    capture_64_strb_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_predicate_op60_write_state3, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op60_write_state3 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    capture_64_user_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_predicate_op60_write_state3, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op60_write_state3 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    i_2_fu_231_p2 <= std_logic_vector(unsigned(i_reg_146) + unsigned(ap_const_lv32_FFFFFFFF));
    i_3_fu_257_p2 <= std_logic_vector(unsigned(ap_phi_mux_i_1_phi_fu_160_p4) + unsigned(ap_const_lv32_1));
    samples_1_fu_246_p2 <= std_logic_vector(unsigned(samples_fu_76) + unsigned(ap_const_lv32_1));
    tmp_1_fu_182_p2 <= "1" when (signed(i_reg_146) < signed(length_read_reg_270)) else "0";
    tmp_2_fu_173_p1 <= trigger_V(32 - 1 downto 0);
    tmp_3_fu_211_p1 <= trace_64_data_V_0_data_out(32 - 1 downto 0);
    tmp_5_fu_215_p2 <= (tmp_3_fu_211_p1 and tmp_2_reg_280);
    tmp_6_fu_220_p2 <= "1" when (tmp_5_fu_215_p2 = tmp_2_reg_280) else "0";
    tmp_7_fu_225_p2 <= (tmp_6_fu_220_p2 or ap_phi_mux_match_phi_fu_139_p4);
    tmp_fu_167_p2 <= std_logic_vector(signed(ap_const_lv32_FFFFFFFF) + signed(length_r));

    trace_64_TDATA_blk_n_assign_proc : process(trace_64_data_V_0_state, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0, tmp_1_fu_182_p2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (tmp_1_fu_182_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    trace_64_data_V_0_ack_out_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, tmp_1_fu_182_p2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_1_fu_182_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    trace_64_dest_V_0_ack_out_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, tmp_1_fu_182_p2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_1_fu_182_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    trace_64_id_V_0_ack_out_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, tmp_1_fu_182_p2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_1_fu_182_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    trace_64_keep_V_0_ack_out_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, tmp_1_fu_182_p2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_1_fu_182_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    trace_64_strb_V_0_ack_out_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, tmp_1_fu_182_p2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_1_fu_182_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    trace_64_user_V_0_ack_out_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, tmp_1_fu_182_p2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_1_fu_182_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    trace_temp_last_V_fu_241_p2 <= "1" when (samples_fu_76 = tmp_reg_275) else "0";
end behav;
